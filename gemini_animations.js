...
$( ".back_fabric-draw, .next_7" ).click(function() {
    changeDraw('#back_fabric_2', '.back_fabric-draw');
});

$( ".back_hem-draw, .next_8" ).click(function() {
    changeDraw('#back_hem_3', '.back_hem-draw');
});

$( ".back_drive-draw, .next_9" ).click(function() {
    changeDraw('#back_drive_4', '.back_drive-draw');
});

$( ".back_adv-draw, .next_10" ).click(function() {
    changeDraw('#back_sg_adv_7', '.back_adv-draw');    
});
