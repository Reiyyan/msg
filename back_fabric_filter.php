    ...
    if($shade == "roller shade" || $shade == "fixed shade" || $shade == "vision shade" || $shade == "gemini dual shade"){
        ...
        if($railroad == 'false' ){
            ...
            while($rows = $resultSet->fetch_assoc())
                        ...
                        <div class='sg-box'>
                            <div>
                                <label for='back_$optionDesc'> 
                                <img class='sg-box-image' src='$optionURL$optionColour.jpg' alt='$optionDesc'>
                                </label>
                                <label class='sg-swatch-label'>
                                        <input type='radio' class='back_fabricRadio' name='back_fabric' onclick='back_getFabric(this.value)' id='back_$optionDesc' value='$optionDesc'>
